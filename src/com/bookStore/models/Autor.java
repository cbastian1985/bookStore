...
public class Autor {
    ...
    public Autor(DatosAutor autorApi) {
        this.nombre = autorApi.nombre();
        this.cumpleanios = autorApi.birth_year();
        this.fechaFallecimiento = autorApi.death_year();
    }
    ...
    public Integer getCumpleanios() { return cumpleanios; }
    public void setCumpleanios(Integer cumpleanios) { this.cumpleanios = cumpleanios; }
